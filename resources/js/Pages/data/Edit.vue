          ...
          <div class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="show">
              ...
              <div class="card w-3/5 bg-green-100 shadow-xl mx-auto ">
                <div class="card-body">
                  <h2 class="card-title mx-auto">Update Data</h2>
                  <!-- Cabang ID -->

                  <form class="w-full max-w-lg mx-auto" @submit.prevent="form.put('update',form.id)">
                    <div class="flex flex-wrap -mx-3 mb-3">
                      <div class="w-full md:w-1/2 px-3 mb-3 md:mb-0">

                        <select class="select select-bordered  w-full max-w-xs" v-model="form.cabang_id">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-3">
                      ...
                      <div class="w-full md:w-1/2 px-3 ">
                        ...
                        <div
                          ...
                          <div class="form-check form-check-inline mt-2 mr-5 ">
                            <input v-model="form.jenis_kelamin"
                              :checked="props.datapelita.jenis_kelamin==1 || props.datapelita.jenis_kelamin==3"
                            ...
                            <label class="form-check-label inline-block text-gray-800"
                              for="inlineRadio10">Laki-laki</label>
                          </div>
                          <div class="form-check form-check-inline mt-2">
                            <input v-model="form.jenis_kelamin"
                              :checked="props.datapelita.jenis_kelamin==2 || props.datapelita.jenis_kelamin==4"
                              class="form-check-input form-check-input appearance-none rounded-full h-4 w-4 border border-green-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                        ...
                        <p class="text-red-500 text-xs italic" v-if="$page.props.errors.jenis_kelamin">{{
                    ...
                    <div class="flex flex-wrap -mx-3 mb-3">
                      <div class="w-full md:w-1/2 px-3 mb-3 md:mb-0">
                        ...
                        <p class="text-red-500 text-xs italic" v-if="$page.props.errors.tgl_mohonTao">{{
                      ...
                      jenis kelamin= {{props.datapelita.jenis_kelamin }}
                    </div>
                    <!-- button save -->
...
const form = useForm({
  ...
  keterangan: props.datapelita.keterangan,
  cabang_id: props.datapelita.cabang_id
});
</script>
